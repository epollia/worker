 ...
 * @noinspection unused
 */
public class _CDATA_Telnet extends GeneralTelnet  {
     ...
     */
    public _CDATA_Telnet(Map<String, String> coordinates, Map<String, String> settings, Map<String, String> credentials, Map<String, Map<String, String>> jobs, Map<String, DTOVariableConvertResult> variables)
    {
        /*
         * Parent constructor
         */
    ...
    protected Boolean performJobs()
    {
        ...
        try {
            ...
            WindowSizeOptionHandler winopt = new WindowSizeOptionHandler(500, 500, false,true,true,false);

            client.addOptionHandler(ttopt);
            client.addOptionHandler(echoopt);
            client.addOptionHandler(gaopt);
            client.addOptionHandler(winopt);
